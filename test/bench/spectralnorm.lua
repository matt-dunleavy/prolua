-- floats and closures: spectral norm (Computer Language Benchmarks Game)
...
for i = 1, N do
  local ui, vi = u[i], v[i]
  vBv = vBv + ui * vi; vv = vv + vi * vi
end
io.write(string.format("%0.9f  %.3fs\n", math.sqrt(vBv / vv), os.clock() - t0))
